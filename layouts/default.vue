  ...
  <div>
    ...
    <footer class="footer mt-auto p-10 bg-neutral text-neutral-content">
      <div>
        ...
        <p>GAQNO Development <br>Providing reliable tech since 2020</p>
      </div>
      <div>
        ...
        <div class="grid grid-flow-col gap-4">
          <a href="https://github.com/gaqno" target="_blank">
            <Icon name="mdi:github" size="2em" />
          </a>
          <a href="https://linkedin.com/in/gaqno" target="_blank">
